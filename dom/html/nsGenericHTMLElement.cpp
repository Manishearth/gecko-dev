...
{
  if (!(aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Font) |
  ...
  if (aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Font))) {
    if (!aData->PropertyIsSet(eCSSProperty__x_lang)) {
      aData->SetIdentStringValue(eCSSProperty__x_lang,
...
{
  if (aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(UserInterface))) {
...
nsGenericHTMLElement::MapImageMarginAttributeInto(const nsMappedAttributes* aAttributes,
                                                  GenericSpecifiedValues* aData)
{
  if (!(aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Margin))))
    return;
  ...
  if (value) {
    if (value->Type() == nsAttrValue::eInteger) {
      ...
      if (!aData->PropertyIsSet(eCSSProperty_margin_right)) {
        aData->SetPixelValue(eCSSProperty_margin_right,
                                    (float)value->GetIntegerValue());
      }
    } else if (value->Type() == nsAttrValue::ePercent) {
      if (!aData->PropertyIsSet(eCSSProperty_margin_left)) {
        aData->SetPercentValue(eCSSProperty_margin_left,
                                      value->GetPercentValue());
      }
      if (!aData->PropertyIsSet(eCSSProperty_margin_right)) {
        aData->SetPercentValue(eCSSProperty_margin_right,
                                      value->GetPercentValue());
      }
    }
  }
  ...
  if (value) {
    if (value->Type() == nsAttrValue::eInteger) {
      if (!aData->PropertyIsSet(eCSSProperty_margin_top)) {
        aData->SetPixelValue(eCSSProperty_margin_top,
                                    (float)value->GetIntegerValue());
      }
      if (!aData->PropertyIsSet(eCSSProperty_margin_bottom)) {
        aData->SetPixelValue(eCSSProperty_margin_bottom,
                                    (float)value->GetIntegerValue());
      }
    } else if (value->Type() == nsAttrValue::ePercent) {
      if (!aData->PropertyIsSet(eCSSProperty_margin_top)) {
        aData->SetPercentValue(eCSSProperty_margin_top,
                                      value->GetPercentValue());
      }
      if (!aData->PropertyIsSet(eCSSProperty_margin_bottom)) {
        aData->SetPercentValue(eCSSProperty_margin_bottom,
                                      value->GetPercentValue());
      }
    }
  }
...
nsGenericHTMLElement::MapImageBorderAttributeInto(const nsMappedAttributes* aAttributes,
                                                  GenericSpecifiedValues* aData)
{
  if (!(aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Border))))
    return;
  ...
  if (!aData->PropertyIsSet(eCSSProperty_border_top_width))
    aData->SetPercentValue(eCSSProperty_border_top_width, (float)val);
  if (!aData->PropertyIsSet(eCSSProperty_border_right_width))
    aData->SetPercentValue(eCSSProperty_border_right_width, (float)val);
  if (!aData->PropertyIsSet(eCSSProperty_border_bottom_width))
    aData->SetPercentValue(eCSSProperty_border_bottom_width, (float)val);
  if (!aData->PropertyIsSet(eCSSProperty_border_left_width))
    aData->SetPercentValue(eCSSProperty_border_left_width, (float)val);

  if (!aData->PropertyIsSet(eCSSProperty_border_top_style))
    aData->SetKeywordValue(eCSSProperty_border_top_style,
                                  NS_STYLE_BORDER_STYLE_SOLID);
  if (!aData->PropertyIsSet(eCSSProperty_border_right_style))
    aData->SetKeywordValue(eCSSProperty_border_right_style,
                                  NS_STYLE_BORDER_STYLE_SOLID);
  if (!aData->PropertyIsSet(eCSSProperty_border_bottom_style))
    aData->SetKeywordValue(eCSSProperty_border_bottom_style,
                                  NS_STYLE_BORDER_STYLE_SOLID);
  if (!aData->PropertyIsSet(eCSSProperty_border_left_style))
    aData->SetKeywordValue(eCSSProperty_border_left_style,
                                  NS_STYLE_BORDER_STYLE_SOLID);

  if (!aData->PropertyIsSet(eCSSProperty_border_top_color))
    aData->SetCurrentColor(eCSSProperty_border_top_color);
  if (!aData->PropertyIsSet(eCSSProperty_border_right_color))
    aData->SetCurrentColor(eCSSProperty_border_right_color);
  if (!aData->PropertyIsSet(eCSSProperty_border_bottom_color))
    aData->SetCurrentColor(eCSSProperty_border_bottom_color);
  if (!aData->PropertyIsSet(eCSSProperty_border_left_color))
    aData->SetCurrentColor(eCSSProperty_border_left_color);
}
                                        ...
                                        GenericSpecifiedValues* aData)
{
  ...
  if (!(aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Background))))
    return;

  nsPresContext* presContext = aData->GetPresContext();
                                     ...
                                     GenericSpecifiedValues* aData)
{
  ...
  if (!aData->PropertyIsSet(eCSSProperty_background_color) &&
      aData->GetPresContext()->UseDocumentColors()) {
