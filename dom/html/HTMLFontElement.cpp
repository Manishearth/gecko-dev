                                       ...
                                       GenericSpecifiedValues* aData)
{
  ...
  if (aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(TextReset)) &&
      aData->GetPresContext()->CompatibilityMode() == eCompatibility_NavQuirks) {
    ...
    nscolor color;
    if (value && value->GetColorValue(color)) {
      aData->SetTextDecorationUnderlineForce();
    }
  }
