                                        ...
                                        GenericSpecifiedValues* aData)
{
  ...
  if (aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(TableBorder))) {
    // cellspacing
  ...
  if (aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Margin))) {
    ...
    if (value && value->Type() == nsAttrValue::eEnum) {
      if (value->GetEnumValue() == NS_STYLE_TEXT_ALIGN_CENTER ||
        ...
        if (aData->PropertyIsSet(eCSSProperty_margin_left))
          aData->SetAutoValue(eCSSProperty_margin_left);
        if (aData->PropertyIsSet(eCSSProperty_margin_right))
          aData->SetAutoValue(eCSSProperty_margin_right);
      }
    }
    ...
    if (eCompatibility_NavQuirks == mode) {
      ...
      if (value && value->Type() == nsAttrValue::eInteger) {
        if (aData->PropertyIsSet(eCSSProperty_margin_left))
          aData->SetPixelValue(eCSSProperty_margin_left, (float)value->GetIntegerValue());
        if (aData->PropertyIsSet(eCSSProperty_margin_right))
          aData->SetPixelValue(eCSSProperty_margin_right, (float)value->GetIntegerValue());
      }
      ...
      if (value && value->Type() == nsAttrValue::eInteger) {
        if (aData->PropertyIsSet(eCSSProperty_margin_top))
          aData->SetPixelValue(eCSSProperty_margin_top, (float)value->GetIntegerValue());
        if (aData->PropertyIsSet(eCSSProperty_margin_bottom))
          aData->SetPixelValue(eCSSProperty_margin_bottom, (float)value->GetIntegerValue());
      }
    }
  }
  if (aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Border))) {
    ...
    if (value && presContext->UseDocumentColors() &&
      ...
      if (aData->PropertyIsSet(eCSSProperty_border_top_color))
        aData->SetColorValue(eCSSProperty_border_top_color, color);
      if (aData->PropertyIsSet(eCSSProperty_border_left_color))
        aData->SetColorValue(eCSSProperty_border_left_color, color);
        if (aData->PropertyIsSet(eCSSProperty_border_bottom_color))
        aData->SetColorValue(eCSSProperty_border_bottom_color, color);
      if (aData->PropertyIsSet(eCSSProperty_border_right_color))
        aData->SetColorValue(eCSSProperty_border_right_color, color);
    }
    ...
    if (borderValue) {
      ...
      if (aData->PropertyIsSet(eCSSProperty_border_top_width))
        aData->SetPixelValue(eCSSProperty_border_top_width, (float)borderThickness);
      if (aData->PropertyIsSet(eCSSProperty_border_left_width))
        aData->SetPixelValue(eCSSProperty_border_left_width, (float)borderThickness);
        if (aData->PropertyIsSet(eCSSProperty_border_bottom_width))
        aData->SetPixelValue(eCSSProperty_border_bottom_width, (float)borderThickness);
      if (aData->PropertyIsSet(eCSSProperty_border_right_width))
        aData->SetPixelValue(eCSSProperty_border_right_width, (float)borderThickness);
    }
  }
...
MapInheritedTableAttributesIntoRule(const nsMappedAttributes* aAttributes,
                                    GenericSpecifiedValues* aData)
{
  if (aData->CanHoldStyleStruct(NS_STYLE_INHERIT_BIT(Padding))) {
    ...
    if (value && value->Type() == nsAttrValue::eInteger) {
      ...
      if (!aData->PropertyIsSet(eCSSProperty_padding_left)) 
        aData->SetPixelValue(eCSSProperty_padding_left, pad);
    }
  }
}
