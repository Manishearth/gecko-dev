                    ...
                    |value| {
                        ...
                        match *value {
                            DeclaredValue::Value(ref specified_value) => {
                                % if property.ident in SYSTEM_FONT_LONGHANDS:
...
<%def name="single_keyword_system(name, values, cast_to=None, **kwargs)">
    <%
    ...
    <%call expr="longhand(name, keyword=Keyword(name, values, **keyword_kwargs), **kwargs)">
        ...
        pub mod computed_value {
            ...
            ${gecko_keyword_conversion(keyword, keyword.values_for(product), type="T", cast_to=cast_to)}
        }
        ...
        impl ToComputedValue for SpecifiedValue {
            ...
            fn to_computed_value(&self, cx: &Context) -> Self::ComputedValue {
                match *self {
                    ...
                    SpecifiedValue::System(_) => cx.style.cached_system_font.as_ref().unwrap().${to_rust_ident(name)}.clone(),
                }
            }
