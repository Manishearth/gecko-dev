...
{
  RefPtr<ServoComputedValues> computedValues = Servo_GetComputedValues(aContent).GetRefPtr();
...
ServoStyleSet::ResolveStyleForOtherNonElement(nsStyleContext* aParentContext)
{
  ...
  RefPtr<ServoComputedValues> computedValues = Servo_InheritComputedValues(parent).GetRefPtr();
  MOZ_ASSERT(computedValues);
                                         ...
                                         Element* aPseudoElement)
{
  ...
  RefPtr<ServoComputedValues> computedValues =
    Servo_GetComputedValuesForPseudoElement(
      ...
      aParentElement, pseudoTag, mRawSet.get(), /* is_probe = */ false).GetRefPtr();
  MOZ_ASSERT(computedValues);
                                       ...
                                       nsStyleContext* aParentContext)
{
  ...
  RefPtr<ServoComputedValues> computedValues =
    Servo_GetComputedValuesForPseudoElement(
      aParentContext->StyleSource().AsServoComputedValues(),
      aParentElement, pseudoTag, mRawSet.get(), /* is_probe = */ true).GetRefPtr();
